(() => {
    ...
    const drawStars = () => {
        //This will create 50 stars at random positions, with random sizes, but not below half of the screen.
        // We can also add a 25px padding to avoid getting stars drawn to the edge of the screen.
